# Ensure the project root is importable when this script is run from setup/.
import os as _hms_os, sys as _hms_sys
_hms_sys.path.insert(0, _hms_os.path.dirname(_hms_os.path.dirname(_hms_os.path.abspath(__file__))))
...
def prune_duplicate_medicines():
    ...
    print("\nPruning complete! Removed duplicates while maintaining inventory for each unique medicine.")

if __name__ == "__main__":
    print("Starting medicine duplicate pruning process...")
    answer = input("Would you like to prune duplicate medicines? This will DELETE medicines from the database. (y/n): ")
